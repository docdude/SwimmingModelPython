...
stroke_axis_params = {
    1: {"width": 5, "prominence": 3.5, "distance": 65},  # Freestyle
            ...
            if current_style in [1, 2, 3, 4]:
                ...
                if current_style == 1:  # Freestyle
                    ...
                    sensor_data.update({
                        ...
                        "style_gyro": gyro_z_pos_filtered,
                    ...
                    sensor_data.update({
                        ...
                        "style_gyro": gyro_z_neg_filtered,
                    ...
                    if DEBUG_SYNCHRONIZATION:
                        ...
                        debug_synchronization(
                            segment_acc_magnitude_filtered, gyro_z_neg_filtered,
                    ...
                    sensor_data.update({
                        ...
                        "style_gyro": gyro_y_pos_filtered,
                    ...
                    sensor_data.update({
                        "style_acc": segment_acc_magnitude_filtered,
                        "style_gyro": gyro_y_neg_filtered,
                    ...
                    if DEBUG_SYNCHRONIZATION:
                        ...
                        debug_synchronization(
                            segment_acc_magnitude_filtered, gyro_y_neg_filtered,
...
def count_strokes_by_style(normalized_windows, raw_windows, labels, user_number=None, file_name=None):
    ...
    stroke_labels = np.zeros(num_samples, dtype=int)
