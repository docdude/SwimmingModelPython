...
for (i, user_test) in enumerate(users_test):
   ...
   #optimizer = tf.keras.optimizers.Adam(learning_rate=training_parameters['lr'], beta_1=training_parameters['beta_1'],
    ...
    model = cnn_vanilla_dual2.cnn_model(input_shape, swim_model_parameters, stroke_model_parameters, training_parameters, use_seed=True, output_bias=training_bias)
